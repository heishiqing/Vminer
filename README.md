...
### [下载最新版 v0.1.6](https://github.com/heishiqing/Vminer/releases/latest)
...
- 状态显示：查看在线状态、显卡数量、算力、接受份额、拒绝份额和运行状态。
- 日志查看：显示运行日志、矿池连接和挖矿程序输出。
- 矿池入口：可从软件中打开矿池后台。
- 自动运行：支持开机启动、软件启动后自动挖矿、后台静默模式。
- 功耗设置：支持 NVIDIA 显卡功耗百分比设置。
...
**lpminer：** LuckyPool, BaikalMine

**SRBMiner：** LuckyPool, HeroMiners, Suprnova, BaikalMine
