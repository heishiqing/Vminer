...
- 修复内核版本列表刷新失败的问题，服务器上架新内核后客户端可正常显示新版本。
- 上架 WildRig 0.49.2 可选内核。
...
- Fixed kernel-version refresh so newly published server-side kernels appear in the client.
- Added WildRig 0.49.2 as a selectable kernel.
